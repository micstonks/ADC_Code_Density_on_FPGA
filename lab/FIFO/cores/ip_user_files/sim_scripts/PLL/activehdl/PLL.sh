...
#
# Generated by Vivado on Thu Feb 05 11:16:29 +0100 2026
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/ADC_Code_Density_on_FPGA/lab/FIFO/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/activehdl"
  fi
